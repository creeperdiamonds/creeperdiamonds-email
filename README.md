...
holds only dark mode, client resets, and two mobile padding rules — nice to have, not load-bearing.
...
| `assets/appealy-icon.png` | 56×56 | 4 KB | Appealy's own icon, from `brand/icon.svg` in its repo, rasterised because Gmail and Outlook strip SVG. 168px source (3×) for retina; `border-radius:12px` matches the artwork's own 114/512 corner at this size. |
